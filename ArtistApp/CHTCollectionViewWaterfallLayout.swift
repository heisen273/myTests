...
//    private property and method above.
    ...
    override func prepare(){
        ...
        //self.collectionView?.backgroundColor = UIColor(red:98, green:0.98, blue:0.98, alpha:1.0)
        ...
        for section in 0 ..< numberOfSections{
            ...
            */
            var minimumInteritemSpacing : CGFloat = 100
    ...
    override var collectionViewContentSize : CGSize{
        ...
        contentSize.height = CGFloat(height.doubleValue) + 65
        return  contentSize
    }
